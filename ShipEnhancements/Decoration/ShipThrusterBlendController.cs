...
public class ShipThrusterBlendController : ColorBlendController
{
    ...
    protected override void Awake()
    {
        ...
        _rainbowTex = ShipEnhancements.LoadAsset<Texture2D>("Assets/ShipEnhancements/Decoration/ThrusterColors/ThrusterFlames_White.png");
        _editedTex = new Texture2D(_rainbowTex.width, _rainbowTex.height);

        var tex = ShipEnhancements.LoadAsset<Texture2D>("Assets/ShipEnhancements/Decoration/ThrusterColors/ThrusterFlames_Default.png");
    ...
    protected override void SetBlendTheme(int i, string themeName)
    {
        ...
        Texture2D tex = ShipEnhancements.LoadAsset<Texture2D>("Assets/ShipEnhancements/Decoration/ThrusterColors/"
            + theme.ThrusterColor);
