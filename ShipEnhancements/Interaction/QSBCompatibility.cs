...
public class QSBCompatibility
{
    ...
    private SettingPresets.PresetName _hostPreset = SettingPresets.PresetName.Custom;
    ...
    {
        _hostPreset = (SettingPresets.PresetName)preset;
    }

    public SettingPresets.PresetName GetHostPreset()
    {
        return _hostPreset;
    }
    #endregion
