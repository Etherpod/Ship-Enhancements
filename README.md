...
- **Ship Signal**: Adds a signal for the ship on the Deep Space Radio frequency. Best used with **Disable Map Markers**.
...
## Multiplayer
Currently there is no support for multiplayer (Quantum Space Buddies). You can still technically do multiplayer with this mod enabled, but things will definitely break.
...
And thanks to the Outer Wilds Modding Community, this mod wouldn't have been possible without them.